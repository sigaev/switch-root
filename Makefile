install:
	...
	gcc -O2 -mavx512cd -mavx512f -pipe -Wall -c -o x86gflops-avx-512.o -std=c99 x86gflops-avx-512.c
	./pp.pl x86gflops-sse.c | gcc -O2 -msse2 -pipe -Wall -Xlinker -s -o x86gflops x86gflops-avx.o x86gflops-avx-512.o -x c -std=c99 - x86gflops.c
